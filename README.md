...
Site fictíco desenvolvido para praticar utilização de HTML e CSS.

## :dart: Objetivo do Projeto

```bash
Praticar conhecimentos sobre HTML5, CSS3.
...
git clone https://github.com/cleuber-andrade/Landing_January.git
